...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 05-06-2021 a las 04:35:31
...
CREATE TABLE `rol` (
  ...
  `habil` int(11) NOT NULL,
  `agrega` int(11) NOT NULL,
  `edita` int(11) NOT NULL,
  `muestra` int(11) NOT NULL,
  `elimina` int(11) NOT NULL,
  `administrar` int(11) NOT NULL
...
INSERT INTO `rol` (`idrol`, `rol`, `habil`, `agrega`, `edita`, `muestra`, `elimina`, `administrar`) VALUES
(1, 'ADMIN', 1, 1, 1, 1, 1, 1),
(2, 'VISITANTE', 0, 0, 0, 0, 0, 0),
(3, 'INVITADO', 1, 0, 0, 1, 0, 0),
(4, 'CAJERO', 1, 0, 1, 1, 0, 0);
...
INSERT INTO `tb_login` (`usu`, `pass`, `idrol`) VALUES
('admin', '12345', 1),
('hrozob', 'hrozob', 4),
('invitado', 'invitado', 2);
...
--
ALTER TABLE `tb_login`
  ADD CONSTRAINT `tb_login_ibfk_1` FOREIGN KEY (`idrol`) REFERENCES `rol` (`idrol`) ON DELETE CASCADE ON UPDATE CASCADE;
